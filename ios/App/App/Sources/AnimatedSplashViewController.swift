...
///   3. JS calls DeviceActivity.dismissSplash() when the app is ready
...
final class AnimatedSplashViewController: UIViewController {
    ...
    /// Weak reference so the plugin can find and dismiss the splash.
    /// Set by AppDelegate when the splash is presented.
    static weak var shared: AnimatedSplashViewController?
