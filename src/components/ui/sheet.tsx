...
// Removed animate-in/animate-out and slide-in/slide-out classes — these use
// tailwindcss-animate keyframes that get stuck on iOS WebView (Capacitor),
// leaving elements invisible and causing a black screen.
