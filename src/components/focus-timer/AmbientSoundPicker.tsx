...
export const AmbientSoundPicker = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent variant="bottom-sheet" className="p-0 overflow-hidden border-2 border-border border-b-0 rounded-t-2xl">
          ...
          <DialogHeader>
            <DialogTitle className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <span className="text-lg font-bold block">Focus Sounds</span>
        ...
        <div
          className="px-5 space-y-4 overflow-y-auto overscroll-contain"
          style={{
        ...
        >
          ...
          {layers.length > 0 && (
            <div
              ...
              style={{
                background: isPlaying
                  ? 'linear-gradient(180deg, hsl(140 40% 94%) 0%, hsl(140 35% 89%) 100%)'
                  : 'linear-gradient(180deg, hsl(var(--muted) / 0.5) 0%, hsl(var(--muted) / 0.3) 100%)',
                border: `2px solid ${isPlaying ? 'hsl(140 40% 72%)' : 'hsl(var(--border))'}`,
            ...
            >
                ...
                <div className="space-y-2 mb-3">
                  {layerDetails.map((layer) => (
                    ...
                    >
                      ...
                      <span className="text-[11px] font-bold flex-shrink-0 max-w-[60px] truncate">
                        {layer.sound?.name}
                      </span>
                      <Slider
                        min={0}
                      ...
                      <button
                        ...
                        className="w-9 h-9 rounded-full flex items-center justify-center text-muted-foreground hover:text-red-500 transition-colors flex-shrink-0 active:scale-90"
              ...
              >
                ...
                <span
                  className="text-[11px] font-bold w-9 text-center py-1 rounded-md flex-shrink-0"
                  style={{
          ...
          {/* Category Filters */}
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide -mx-5 px-5 snap-x">
            <button
              onClick={() => setSelectedCategory('all')}
              className="px-3.5 py-2 min-h-[40px] rounded-xl text-xs font-bold whitespace-nowrap transition-all active:scale-95 flex items-center gap-1.5 snap-start flex-shrink-0"
              style={{
                ...
                {freeSounds.map((sound) => {
                  ...
                  return (
                    <button
                      ...
                      className="relative p-3 rounded-2xl text-left transition-all active:scale-[0.97]"
                      style={{
                        background: isCurrentlyPlaying
                          ? 'linear-gradient(180deg, hsl(140 40% 94%) 0%, hsl(140 35% 87%) 100%)'
                          : isInLayers
                          ? 'linear-gradient(180deg, hsl(260 40% 96%) 0%, hsl(260 30% 91%) 100%)'
                          : 'linear-gradient(180deg, hsl(var(--card)) 0%, hsl(var(--muted) / 0.3) 100%)',
                ...
                {premiumSounds.map((sound) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isLocked}
                      className={cn(
                        "relative p-3 rounded-2xl text-left transition-all active:scale-[0.97]",
                        isLocked && "opacity-70"
                      )}
                      style={{
                        background: isCurrentlyPlaying
                          ...
                          : isInLayers
                          ? 'linear-gradient(180deg, hsl(260 40% 96%) 0%, hsl(260 30% 91%) 100%)'
                          : 'linear-gradient(180deg, hsl(40 60% 97%) 0%, hsl(35 50% 93%) 100%)',
          ...
          {!isPremium && (
            <div
              ...
              style={{
                background: 'linear-gradient(180deg, hsl(45 80% 93%) 0%, hsl(40 70% 88%) 100%)',
