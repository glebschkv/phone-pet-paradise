...
export const BIOME_DATABASE: BiomeData[] = [
  {
    name: 'Snow',
    unlockLevel: 0,
    description: 'A cozy winter wonderland where your journey begins.',
    animals: ['mushroom-kid', 'bunny-hood', 'star-wizard', 'cat-hood'],
  ...
  },
  {
    name: 'Meadow',
    unlockLevel: 5,
    description: 'A peaceful meadow filled with friendly creatures.',
